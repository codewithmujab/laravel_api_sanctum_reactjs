  ...
  return (
    <div className="antialiased animated fadeInDown">
      <div className="max-w-lg mx-auto my-1 bg-white p-8 border-r border-l border-gray-100">
        ...
        <p className="text-slate-500">Selamat datang, masukkan kredensial Anda untuk melanjutkan.</p>
        ...
        <form onSubmit={onSubmit} className="pt-5">
          <div className="flex flex-col space-y-5">
            ...
            <label htmlFor="password">
              ...
              <input ref={passwordRef} type="password" placeholder="Masukan Password" className="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" />
            </label>
            <div className="flex flex-row justify-between">
              <div>
              </div>
              <div>
                <Link to="/forgot-password" className="font-medium text-orange-600">
                  Lupa Password</Link>
              </div>
            </div>
            ...
            <p className="text-center">Belum punya akun? <Link to="/signup" className="text-orange-600 font-medium inline-flex space-x-1 items-center"><span>Daftar
